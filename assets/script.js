function play() {
    var audio = new Audio('assets/audio/3.mp3');audio.play();}
    ...
    function showFt() {document.getElementById('foto').style.display = "block";}
      ...
      var e1 = document.getElementById('img_aku');e1.classList.add("degdeg");
      var e2 = document.getElementById('img_kamu');e2.classList.add("degdeg");}
